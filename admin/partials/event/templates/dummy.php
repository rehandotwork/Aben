...
<body>
    ...
    <table role="presentation" id="email-container" cellspacing="0" cellpadding="0"
        style="width:100%;max-width:600px;margin:0 auto;padding:20px; background-color:<?php echo $body_bg; ?>;">
        <!-- Header Section -->
        <tbody>
            <tr>
                <td id="email-header"
            ...
            <tr>
                <td id="email-footer"
                    ...
                    <a style="display: inline-block;" href="<?php echo site_url('/')?>">
                        <img src="<?php echo esc_url($site_logo) ?>" alt="<?php echo bloginfo( 'name' )?>"></a>

                    <p id="footer-text-event"><?php echo esc_html($footer_text) ?></p>

                    <!-- Branding -->
                    <?php if(!Aben_Email::is_pro()):?>
                    <p> <?php echo esc_html( BRAND_TEXT )?>
                        <a href="<?php echo esc_url(BRAND_LINK) ?>" style="text-decoration:none; display:inline-block;">
                            <img src="<?php echo esc_url(PLUGIN_LOGO) ?>" width="60px" alt="Aben"
